...
/*   Updated: 2017/03/21 11:53:58 by gthomas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_realloc_ptrptr(char ***ptr, int buffer);
void				ft_realloc_int(int **tab, const int int_size,
	const int buffer);
char				*get_str_before(char *out, const char *str, char c);
char				*get_nb_char(const char *str, int nb);
int					ft_strichr_last(char const *s, char c);
